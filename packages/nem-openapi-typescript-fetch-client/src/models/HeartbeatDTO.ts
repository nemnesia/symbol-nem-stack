...
/**
 * Check if a given object implements the HeartbeatDTO interface.
 */
export function instanceOfHeartbeatDTO(value: object): value is HeartbeatDTO {
    return true;
}

export function HeartbeatDTOFromJSON(json: any): HeartbeatDTO {
    return HeartbeatDTOFromJSONTyped(json, false);
}

export function HeartbeatDTOFromJSONTyped(json: any, ignoreDiscriminator: boolean): HeartbeatDTO {
    if (json == null) {
        return json;
    }
    return {
...
export function HeartbeatDTOToJSON(json: any): HeartbeatDTO {
    return HeartbeatDTOToJSONTyped(json, false);
}

export function HeartbeatDTOToJSONTyped(value?: HeartbeatDTO | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
