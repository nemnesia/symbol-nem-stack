...
- 仕様本文、コンセプト本文、コンセプトレビュー結果、要件本文、要件レビュー結果、ユーザー提供資料、承認済みの要件またはプロジェクト資料を根拠の種別として区別する。レビュー結果は公開された findings の内容だけを参照し、内部討議や思考過程を推測しない。未確認の事実、推測、好みを事実として扱わない。
