...
技術的実現性、運用、ライセンス、法務、セキュリティ、継続性、保守性に関する不可欠な前提を確認する。コーディング方法や詳細設計は指摘しない。

技術的または安全性上の前提を評価する必要がある場合だけ、`docs/knowledge` の関連資料を選んで参照する。コンセプト本文、ユーザー提供資料、`docs/knowledge` の確認済み資料を区別し、未確認事項を断定しない。資料を確認できないこと自体を問題にせず、要件定義開始に不可欠な未確認前提だけを指摘候補とする。
